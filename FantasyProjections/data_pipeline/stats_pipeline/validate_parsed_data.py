...
def validate_parsed_data(final_stats_df, urls_df, validated_features, scrape=False, save_data=False):
    """Compares the final statistics generated by play-by-play parsing to true statistics scraped from the internet.
        ...
        Args:
            ...
            validated_features (list): List of statistics to compute differences between truth and parsed data.
    ...
    diff_df = __compare_dfs(true_df, final_stats_df, validated_features)

    # Log comparison performance
    __print_validation_comparison(diff_df, validated_features)
    ...
    __plot_validation_comparison(diff_df, validated_features)
