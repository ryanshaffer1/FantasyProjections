...
def clean_stats_data(midgame_df, final_stats_df, list_of_stats='default'):
    ...
    final_stats_df = final_stats_df[['Player Name', 'Team', 'Opponent', 'Position', 'Age', 'Site'] + ALT_PLAYER_IDS + list_of_stats]
...
def clean_team_names(team_names, year=None):
    ...
    if team_names == 'all':
        ...
        team_abbrs.adjust_team_names((team_abbrs.pbp_abbrevs,
