...
if __name__ == "__main__":
    ...
    slice1 = all_data.slice_by_criteria(inplace=False, player_ids=[name_to_id('Austin Ekeler')], years=[2024], weeks=[1], elapsed_time=[0,1,2,3])
    slice2 = all_data.slice_by_criteria(inplace=False, player_ids=[name_to_id('Olamide Zaccheaus')], years=[2024], weeks=[4], elapsed_time=[22,23,24])
    slice3 = all_data.slice_by_criteria(inplace=False, player_ids=[name_to_id('Jayden Daniels')], years=[2024], weeks=[3], elapsed_time=[18])
    slice4 = all_data.slice_by_criteria(inplace=False, player_ids=[name_to_id('Zach Ertz')], years=[2023], weeks=[5], elapsed_time=[13])
    slice5 = all_data.slice_by_criteria(inplace=False, player_ids=[name_to_id('Zach Ertz')], years=[2024], weeks=[5], elapsed_time=[53])
